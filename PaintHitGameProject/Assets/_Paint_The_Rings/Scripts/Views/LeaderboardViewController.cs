    ...
    public class LeaderboardViewController : MonoBehaviour
    {
        ...
        public void OnShow()
        {
            ...
            else
            {
                ...
                localLevelTxt.text = "Level: " + PlayerPrefs.GetInt(PlayerPrefsKeys.PPK_SAVED_LEVEL).ToString();
        ...
        /// <summary>
        /// Creating leaderboard items and set local user datas.
        /// </summary>
            ...
            else
            {
                ...
                ServicesManager.Instance.LeaderboardManager.CheckUsernameExists(username, (isExists) =>
                {
                    ...
                    else
                    {
                        ...
                        //Save username to local and to leaderboard
